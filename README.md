...
```javascript
iterator = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-iter-uniform@v0.2.2-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/random-iter-uniform/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/random-iter-uniform/actions/workflows/test.yml?query=branch:v0.2.2
