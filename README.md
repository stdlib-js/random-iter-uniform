...
```javascript
iterator = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-iter-uniform@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-iter-uniform/tags). For example,

```javascript
iterator = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-iter-uniform@v0.2.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var iterator = require( 'path/to/vendor/umd/random-iter-uniform/index.js' )
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/random-iter-uniform.svg
[npm-url]: https://npmjs.org/package/@stdlib/random-iter-uniform

[test-image]: https://github.com/stdlib-js/random-iter-uniform/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/random-iter-uniform/actions/workflows/test.yml?query=branch:v0.2.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/random-iter-uniform/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/random-iter-uniform?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/random-iter-uniform.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-iter-uniform/main
...
[deno-url]: https://github.com/stdlib-js/random-iter-uniform/tree/deno
[deno-readme]: https://github.com/stdlib-js/random-iter-uniform/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-iter-uniform/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-iter-uniform/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-iter-uniform/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-iter-uniform/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/random-iter-uniform/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/random-iter-uniform/main/LICENSE
